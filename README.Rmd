...
`staged_ev_tree`, or with the functions `indep` and `full`. 
In general we create a staged event tree from data 
...
By defualt stages associated with the unobserved situations are not plotted, 
